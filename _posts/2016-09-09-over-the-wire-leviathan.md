...
I was right! You can see __/bin/cat__ calls __pass file.txt__ as two separate files __pass__ and __file.txt__. We can actually exploit this! Let’s go ahead and create a [symbolic link](https://en.wikipedia.org/wiki/Symbolic_link) for __pass file.txt__ and link it to __/etc/leviathan_pass/leviathan3__.
