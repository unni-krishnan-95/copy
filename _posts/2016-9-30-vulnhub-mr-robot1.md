...
If you never heard of [VulnHub](https://www.vulnhub.com/about/), then let me briefly explain what they do. Their purpose it to provide materials that allows anyone to gain practical 'hands-on' experience in digital security, computer software & network administration. Like many other CTF's, VulnHub in particular was born to cover as many resources as possible, creating a catalogue of 'stuff' that is (legally) 'breakable, hackable & exploitable' - allowing you to learn in a safe environment and practice 'stuff' out. [^[VulnHub](https://www.vulnhub.com/about/)]
